...
import { Search, Plus, Trash2, Truck, X, AlertCircle, ChevronUp, ChevronDown, ChevronLeft, ChevronRight, Check, Loader2, Edit2, Download } from "lucide-react";
...
export default function SuppliersClient({ initialSuppliers }: { initialSuppliers: Supplier[] }) {
  ...
  const handleExportCSV = () => {
    ...
    const data = processedSuppliers.map(s => [
      s.nama_supplier,
      s.telepon || "-",
      s.email || "-",
      s.alamat || "-",
