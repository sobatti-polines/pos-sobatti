...
-- Clean all data (order respects FK constraints)
...
ALTER SEQUENCE barang_masuk_id_seq RESTART WITH 1;
ALTER SEQUENCE transaksi_keluar_id_seq RESTART WITH 1;
ALTER SEQUENCE detail_transaksi_keluar_id_seq RESTART WITH 1;
ALTER SEQUENCE stok_opname_id_seq RESTART WITH 1;
