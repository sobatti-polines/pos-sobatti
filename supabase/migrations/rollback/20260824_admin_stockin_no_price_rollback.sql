-- ============================================================================
-- ROLLBACK: 20260824_admin_stockin_no_price.sql
-- 
-- Tujuan: Mengembalikan fungsi process_barang_masuk ke versi sebelumnya
--         (20260810_guard_hitung_stok.sql) jika terjadi masalah.
--
-- KEAMANAN:
-- - Script ini AMAN dijalankan di production yang sedang aktif
-- - Hanya mengubah definisi fungsi (CREATE OR REPLACE), tidak mengubah tabel
-- - Tidak ada data yang hilang atau terubah
-- - Jika ada transaksi barang masuk sedang berjalan, akan menunggu selesai
--
-- CARA JALAN:
-- 1. Buka Supabase SQL Editor (https://supabase.com/dashboard → SQL Editor)
-- 2. Copy-paste seluruh script ini
-- 3. Klik "Run"
-- 4. Verifikasi: SELECT proname FROM pg_proc WHERE proname = 'process_barang_masuk';
--
-- ============================================================================
...
-- ============================================================================
-- Hapus kolom harga_ditentukan yang ditambahkan migration baru
-- ============================================================================
ALTER TABLE barang_masuk DROP COLUMN IF EXISTS harga_ditentukan;
DROP INDEX IF EXISTS idx_barang_masuk_harga_ditentukan;
...
-- FROM pg_proc p
-- WHERE p.proname = 'process_barang_masuk';
-- ============================================================================
