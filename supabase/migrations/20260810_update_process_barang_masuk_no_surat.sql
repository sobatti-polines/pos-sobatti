...
-- T1-02: Update RPC process_barang_masuk untuk menyimpan no_surat
-- (no. faktur/nota/DO dari supplier) di tabel barang_masuk.
-- Logika inti (UoM, AVCO, dual-stok) TIDAK diubah — hanya menambah kolom.
-- Branch legacy tetap berfungsi: kolom no_surat nullable, tidak wajib diisi.
